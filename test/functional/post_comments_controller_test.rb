...
class PostCommentsControllerTest < ActionController::TestCase
  ...
  test "should create post_comment" do
    assert_difference('PostComment.count') do
      post :create, post_comment: { body: @post_comment.body, email: @post_comment.email, name: @post_comment.name }
    end
  ...
  test "should update post_comment" do
    put :update, id: @post_comment, post_comment: { body: @post_comment.body, email: @post_comment.email, name: @post_comment.name }
    assert_redirected_to post_comment_path(assigns(:post_comment))
  end
